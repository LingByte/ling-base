...
// Adaptor implements relay.Adaptor for Google Gemini.
type Adaptor struct {
	APIKey  string
	BaseURL string
...
func (a *Adaptor) handleChatResponse(info *relay.RelayInfo, body []byte, w http.ResponseWriter) (any, *types.NewAPIError) {
