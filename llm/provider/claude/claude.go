...
import (
	...
	"github.com/LingByte/ling-base/llm/relaykit/relayconvert"
...
// Adaptor implements relay.Adaptor for Anthropic Claude.
type Adaptor struct {
	APIKey      string
	BaseURL     string
...
func (a *Adaptor) handleChatResponse(ctx context.Context, info *relay.RelayInfo, body []byte, w http.ResponseWriter) (any, *types.NewAPIError) {
