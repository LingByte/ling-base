...
```bash
# 只要标准内存布隆（零第三方依赖）
go get github.com/LingByte/ling-base/bloom/memory

# 要可删除的计数布隆
go get github.com/LingByte/ling-base/bloom/counting

# 要自动扩容的可扩展布隆
go get github.com/LingByte/ling-base/bloom/scalable

# 要 Redis 分布式布隆（只会拉 go-redis + bloom 抽象）
go get github.com/LingByte/ling-base/bloom/redis

# 要 RedisBloom 模块布隆（需 Redis 加载 RedisBloom 模块）
go get github.com/LingByte/ling-base/bloom/redisbloom
```

```go
import (
    "github.com/LingByte/ling-base/bloom"
    "github.com/LingByte/ling-base/bloom/memory" // 不会间接引入 redis
)
```
...
import (
    "context"
    "fmt"
    "github.com/LingByte/ling-base/bloom/memory"
)
...
import (
    ...
    "time"
    goredis "github.com/redis/go-redis/v9"
    bloomredisbloom "github.com/LingByte/ling-base/bloom/redisbloom"
)
