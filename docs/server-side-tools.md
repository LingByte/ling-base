...
This is a wire-format reference for the Anthropic provider. LingAgent ships its own
...
MCP servers provide additional tools dynamically. LingAgent supports both local
...
## How LingAgent covers these locally

| Server-side tool | LingAgent equivalent |
| --- | --- |
