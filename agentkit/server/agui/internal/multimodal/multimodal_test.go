...
func TestUserMessageFromInputContentsTextAndImageURL(t *testing.T) {
	...
	assert.Equal(t, compat.ContentTypeText, msg.ContentParts[0].Type)
	assert.Equal(t, "hello", *msg.ContentParts[0].Text)

	assert.Equal(t, compat.ContentTypeImage, msg.ContentParts[1].Type)
...
func TestUserMessageFromInputContentsTypedImageData(t *testing.T) {
	...
	assert.Equal(t, compat.ContentTypeImage, msg.ContentParts[0].Type)
	...
	assert.Equal(t, compat.ContentTypeText, msg.ContentParts[1].Type)
...
func TestUserMessageFromInputContentsTypedAudioURL(t *testing.T) {
	...
	require.NoError(t, err)
	require.Len(t, msg.ContentParts, 1)
	assert.Equal(t, compat.ContentTypeAudio, msg.ContentParts[0].Type)
...
func TestUserMessageFromInputContentsTypedVideoData(t *testing.T) {
	...
	require.NoError(t, err)
	require.Len(t, msg.ContentParts, 1)
	assert.Equal(t, compat.ContentTypeVideo, msg.ContentParts[0].Type)
...
func TestUserMessageFromInputContentsTypedDocumentData(t *testing.T) {
	...
	require.NoError(t, err)
	require.Len(t, msg.ContentParts, 1)
	assert.Equal(t, compat.ContentTypeFile, msg.ContentParts[0].Type)
