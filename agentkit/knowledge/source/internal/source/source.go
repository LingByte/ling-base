...
import (
	...
	"github.com/LingByte/ling-base/agentkit/knowledge/document/reader"
	"github.com/LingByte/ling-base/agentkit/knowledge/ocr"
	"github.com/LingByte/ling-base/agentkit/knowledge/transform"

	_ "github.com/LingByte/ling-base/agentkit/knowledge/document/reader/csv"
	_ "github.com/LingByte/ling-base/agentkit/knowledge/document/reader/json"
	_ "github.com/LingByte/ling-base/agentkit/knowledge/document/reader/markdown"
	_ "github.com/LingByte/ling-base/agentkit/knowledge/document/reader/proto"
	_ "github.com/LingByte/ling-base/agentkit/knowledge/document/reader/text"
)
...
func getGoFileType() string {
	...
	goReaderFallbackWarnOnce.Do(func() {
		slog.Warn("go AST reader is not registered; falling back to text reader",
			"import", "github.com/LingByte/ling-base/agentkit/knowledge/document/reader/golang")
	})
	return "text"
}
...
func getPythonFileType() string {
	...
	pythonReaderFallbackWarnOnce.Do(func() {
		slog.Warn("python AST reader is not registered; falling back to text reader",
			"import", "github.com/LingByte/ling-base/agentkit/knowledge/document/reader/python")
	})
	return "text"
}
