...
import (
	...
	"github.com/LingByte/ling-base/agentkit/knowledge/graph"
...
func TestGraphSeedEmbeddingTextUsesStructuredFieldsAndTruncatesContent(t *testing.T) {
	...
	doc := &document.Document{
		...
		Metadata: map[string]any{
			...
			codeast.TrpcAstMetaPrefix + "full_name": "github.com/LingByte/ling-base/agentkit/openclaw.adminPageHTML",
	...
	for _, want := range []string{
		"type: Variable",
		"name: adminPageHTML",
		"full_name: github.com/LingByte/ling-base/agentkit/openclaw.adminPageHTML",
