...
func (s stubTool) Spec() goagent.ToolSpec { return goagent.ToolSpec{Name: s.name} }
func (stubTool) Invoke(context.Context, goagent.ToolRequest) (goagent.ToolResponse, error) {
	return goagent.ToolResponse{}, errors.New("not implemented")
}
...
func TestToolNames(t *testing.T) {
	...
	tools := []goagent.Tool{stubTool{name: "foo"}, stubTool{name: "bar"}}
...
func TestSubAgentNames(t *testing.T) {
	...
	sas := []goagent.SubAgent{stubSubAgent{name: "alpha"}, stubSubAgent{name: "beta"}}
