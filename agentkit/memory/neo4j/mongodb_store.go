...
func (ms *MongoStore) SearchMemory(ctx context.Context, sessionID string, queryEmbedding []float32, limit int) ([]gomodel.MemoryRecord, error) {
...
func (ms *MongoStore) Iterate(ctx context.Context, fn func(gomodel.MemoryRecord) bool) error {
	if ms == nil || ms.collection == nil {
		return nil
	}
...
type mongoMemoryDocument struct {
	...
	GraphEdges   []gomodel.GraphEdge `bson:"graph_edges,omitempty"`
}

func (doc mongoMemoryDocument) toRecord() gomodel.MemoryRecord {
