...
func (s *Neo4jStore) SearchMemory(ctx context.Context, sessionID string, queryEmbedding []float32, limit int) ([]gomodel.MemoryRecord, error) {
...
func (s *Neo4jStore) Iterate(ctx context.Context, fn func(gomodel.MemoryRecord) bool) error {
...
// relationships.
func (s *Neo4jStore) UpsertGraph(ctx context.Context, record gomodel.MemoryRecord, edges []gomodel.GraphEdge) error {
	if s.driver == nil {
...
func (s *Neo4jStore) Neighborhood(ctx context.Context, sessionID string, seedIDs []int64, hops, limit int) ([]gomodel.MemoryRecord, error) {
	if s.driver == nil {
...
func mapNeo4jRecord(rec neo4jRecord) (gomodel.MemoryRecord, error) {
	if rec == nil {
		return gomodel.MemoryRecord{}, errors.New("neo4j record is nil")
	}
	var out gomodel.MemoryRecord
