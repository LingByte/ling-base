module github.com/LingByte/ling-base/agentkit/session/pgvector
...
require (
	...
	github.com/LingByte/ling-base/agentkit v1.6.0
	github.com/LingByte/ling-base/agentkit/storage/postgres v1.6.0
)
