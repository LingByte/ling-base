...
// Headless (-p) output renderers for text / json / stream-json.
// Event and result shapes mirror the JS reference so differential harnesses
// can compare Go output against `node dist/cli.js -p ... --output-format <fmt>`.
