...
func TestIntro(t *testing.T) {
	...
	for _, want := range []string{"LingAgent", "your preferred coding agent", "openai/gpt-5.5", "go-port", "Esc to interrupt"} {
		if !strings.Contains(got, want) {
	...
	if bare := intro("", "", "the better coding agent"); !strings.Contains(bare, "LingAgent") {
