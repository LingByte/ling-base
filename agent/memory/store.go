...
// Store is LingAgent's substitutable memory backend. The current filesystem
...
// ".ling-agent"). Returns the Store interface rather than the concrete type so
