...
func SetPayloadHash(c context.Context, req any) error {
...
func getPayloadHash(c context.Context) string {
	return ""
}

func Sign(c context.Context, req *http.Request, apiKey string) error {
	header := req.Header
