...
// GetString is a convenience wrapper around Cache.Get.
...
// SetString is a convenience wrapper around Cache.Set.
...
func GetOrSet(ctx context.Context, c Cache, key string, ttl time.Duration, fn func(context.Context) ([]byte, error)) ([]byte, error) {
	if fn == nil {
